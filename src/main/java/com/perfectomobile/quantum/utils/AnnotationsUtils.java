...
public final class AnnotationsUtils {
	...
	public static final String DEFAULT_PLUGINS = "com.qmetry.qaf.automation.cucumber.QAFCucumberFormatter";
	...
	public static void setClassCucumberOptions(Class<?> targetClass, String tagsParam, String gluePackageParam, String featuresFolderParam, String pluginParam, boolean dryRun){
        ...
        String glue = StringUtils.isEmpty(gluePackageParam)? DEFAULT_GLUE_PACKAGE : gluePackageParam;
        ...
        valuesMap.put(GLUE_OPTION, new String[] {glue});
        valuesMap.put(FEATURES_OPTION, new String[] {features});
        ...
        valuesMap.put(PLUGIN_OPTION,new String[] {plugin});
        ...
        System.out.println("Changed Test Cucumber options: " + options.toString() );
    }
